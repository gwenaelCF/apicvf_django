...
def insert_etat():
    ...
    apicvf.models.Etat_dept_produit.objects.bulk_create(dico_etat['dep'], batch_size=5000)
    apicvf.models.Etat_grain_produit.objects.bulk_create(dico_etat['grain'], batch_size=5000)
